...
public class FriActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab=(FloatingActionButton)this.findViewById(R.id.floatingActionButton7);
    ...
    private void createCards(){
        ...
        recyclerView=(RecyclerView)this.findViewById(R.id.recyclerViewFri);
